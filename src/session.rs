...
impl SqliteStore {
    pub fn from_connection(sqlite_connection: Arc<Connection>) -> Self {
    Self{
    ...
    pub fn from_connection_with_table_name(sqlite_connection: Arc<Connection>, table_name: impl AsRef<str>) -> Self {
    Self{
    connection: sqlite_connection,
