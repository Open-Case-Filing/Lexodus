    ...
    view! {
      ...
      <Meta property="og:description" content="Login to the site"/>
        ...
        <div class="text-center mb-8">
            <h1 class="text-4xl font-extrabold text-lexodus-800 mb-2">"Lexodus"</h1>
        ...
        <div class="bg-white bg-lexodus-300 backdrop-filter backdrop-blur-lg p-8 rounded-lg shadow-lg w-full max-w-sm">
            <h2 class="text-2xl font-bold mb-6 text-center text-lexodus-800">"Login"</h2>
          <ActionForm action=action class="space-y-6">
                <div class="mb-4">
                    <label for="username" class="block text-lexodus-800 text-sm font-bold mb-2">"Username"</label>
                ...
                <div class="mb-4">
                    <label for="password" class="block text-lexodus-800 text-sm font-bold mb-2">"Password"</label>
                ...
                <div class="flex items-center justify-between">
                    <button type="submit" class="bg-lexodus-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                        "Log in"
                    </button>
                    <div class="flex">
                        <input
                        ...
                        <label
                            for="remember"
                            class="ml-2 block text-sm text-gray-600 dark:text-white"
                        >
                            "Remember me"
                        </label>
                    </div>
              ...
              <div class="text-center text-sm text-gray-500">
                ...
                <a rel="external" class="text-lexodus-500 underline" href="/signup">
                  "Sign up"
                </a>
                <a rel="external" class="text-lexodus-500 underline" href="/cases">
                  "Already logged in?"
                </a>
